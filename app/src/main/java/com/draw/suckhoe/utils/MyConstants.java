...
public class MyConstants {
    ...
    public static final int BMI_ID = 3;
    public static final int DRINK_WATER_ID = 4;
    public static final int COUNT_STEP_ID = 5;

    public static final int BLOOD_PRESSURE_NAME = 10;
    public static final int BLOOD_GLUCOSE_NAME = 20;
    public static final int BMI_NAME = 30;
    public static final int IS_NAV_MENU = 1;
